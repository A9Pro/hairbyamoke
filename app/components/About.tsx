  ...
  return (
    <section id="about" className="section" style={{ background:"var(--dark-2)", position:"relative", overflow:"hidden" }}>
      {/* ── BACKGROUND TEXTURE IMAGE ────────────────────────────
          Place your image at: public/images/about-bg.jpg
      ──────────────────────────────────────────────────────── */}
      <div style={{
      ...
      <div style={{ position:"absolute", inset:0, background:"linear-gradient(90deg, var(--dark-2) 35%, rgba(22,22,22,0.55) 100%)", zIndex:1 }} />

      <div className="container" style={{ position:"relative", zIndex:2 }}>
        <div className="grid-2">

          {/* ── PORTRAIT ──────────────────────────────────────────
              Place your image at: public/images/about-portrait.jpg
          ───────────────────────────────────────────────────── */}
          <div className="portrait-wrap">
            <div style={{ width:"100%", aspectRatio:"3/4", position:"relative", overflow:"hidden", border:"1px solid rgba(201,168,76,0.22)", backgroundColor:"var(--dark-3)" }}>
              <img
            ...
            {/* Badge */}
            <div className="card" style={{ position:"absolute", bottom:"-20px", right:"-8px", padding:"16px 22px", textAlign:"center", minWidth:"130px", zIndex:3 }}>
